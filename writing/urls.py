...
urlpatterns = [
    ...
    path('admin/students/<int:student_id>/inputs/', views.grade_student, name='grade_student'),
    ...
    path('api/match/<str:code>/delete/', views.match_delete_api, name='match_delete_api'),
